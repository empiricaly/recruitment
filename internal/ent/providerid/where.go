...
func ID(id string) predicate.ProviderID {
	return predicate.ProviderID(func(s *sql.Selector) {
...
func HasParticpant() predicate.ProviderID {
	return predicate.ProviderID(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(ParticpantTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, ParticpantTable, ParticpantColumn),
		)
...
func HasParticpantWith(preds ...predicate.Participant) predicate.ProviderID {
	return predicate.ProviderID(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ParticpantInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, ParticpantTable, ParticpantColumn),
		)
...
func Not(p predicate.ProviderID) predicate.ProviderID {
	return predicate.ProviderID(func(s *sql.Selector) {
		p(s.Not())
	})
}
