...
type DatumResolver interface {
	...
	Root(ctx context.Context, obj *model.Datum) (*string, error)
...
func (ec *executionContext) _Datum_deletedAt(ctx context.Context, field graphql.CollectedField, obj *model.Datum) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Datum().DeletedAt(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Datum_next(ctx context.Context, field graphql.CollectedField, obj *model.Datum) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Datum().Next(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Datum_root(ctx context.Context, field graphql.CollectedField, obj *model.Datum) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Datum().Root(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	for i, field := range fields {
		...
		case "deletedAt":
			...
			out.Concurrently(i, func() (res graphql.Marshaler) {
				...
				res = ec._Datum_deletedAt(ctx, field, obj)
				return res
			})
		case "key":
		...
		case "next":
			...
			out.Concurrently(i, func() (res graphql.Marshaler) {
				...
				res = ec._Datum_next(ctx, field, obj)
				return res
			})
		case "root":
			field := field
			out.Concurrently(i, func() (res graphql.Marshaler) {
				...
				res = ec._Datum_root(ctx, field, obj)
				return res
			})
		case "versions":
			field := field
